          ...
          body: Column(
            children: [
              Container(
                ...
                color:Color.fromARGB(255, 12, 83, 95),//Color.fromARGB(255, 26, 56, 104),
                child: Padding(
                  padding: const EdgeInsets.only(top: 100,bottom:20,left: 15,right: 15),
                  child: Container(//AssetImage('android/assets/images/lion.svg')
                   ...
                   borderRadius: BorderRadius.circular(20),
                    ...
                    child: Center(  
                      child:SvgPicture.asset('android/assets/images/lion.svg',color: Color.fromARGB(255, 219, 227, 241),fit: BoxFit.cover,) 
                    ),
                  ),
                ),
              ),
